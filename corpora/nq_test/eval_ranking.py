...
def calculate_kendall_tau(verify_result, predicted_ranking):
    ...
    try:
        ...
        verify_ranks = [v+1 for v in verify_ranks]
        predicted_ranks_for_verify_items = [p+1 for p in predicted_ranks_for_verify_items]
        # 计算 Kendall's Tau
...
def main():
    ...
    parser.add_argument("--jsonl_file", help="输入的 .jsonl 文件路径", default="nq_test_verification-Qwen2.5-7B-Instruct-retrieval-pointwise-only_facts-cls.json")
