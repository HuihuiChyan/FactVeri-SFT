...
# --- 配置部分 ---
# 请在这里修改你的实际文件名
FILE_1 = 'musique_new_verification-Qwen2.5-3B-Instruct-retrieval-ranking.json'      # 第一个文件（表现较差的）
FILE_2 = 'musique_new_verification-Qwen2.5-7B-Instruct-retrieval-pointwise-sum_history-cls.json'      # 第二个文件（表现较好的）
OUTPUT_FILE = 'musique_new_verification-Qwen2.5-7B-Instruct-retrieval-pointwise-diff_improvement.jsonl' # 输出文件
