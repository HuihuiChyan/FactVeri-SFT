...
python ablation/run_safe.py \
    --model_name $model_name \
    --input_file $dataset_path/$dataset_name_without_ext.jsonl \
    --output_file $dataset_path/$dataset_name_without_ext-$model_name-safe.jsonl

python -u ablation/compare_scoring.py \
    $dataset_path/$dataset_name_without_ext-$model_name-safe.jsonl